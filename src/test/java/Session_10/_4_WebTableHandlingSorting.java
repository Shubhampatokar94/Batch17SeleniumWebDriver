...
public class _4_WebTableHandlingSorting {
	...
	@Test
	public void _2_WebTableHandlingExample1()
	{
	    ...
	    driver.findElement(By.xpath("//table[@id='myTable]/tbody/tr/td[1]'"));    
	    ...
	    System.out.println("-------- Sorted values from after clicking on sort button on page -----------");
	    printArray(array_2);
	    System.out.println("----------------------------------------------------------------");
